...
type ServiceBodyshopRequest struct {
...
type ServiceBodyshopResponse struct {
...
type ServiceBodyshopDetailResponse struct {
	...
	ServiceDetails          ServiceBodyshopDetailsResponse `json:"service_details"`
}

type ServiceBodyshopDetailsResponse struct {
	Page       int                       `json:"page"`
	Limit      int                       `json:"limit"`
	TotalPages int                       `json:"total_pages"`
	TotalRows  int                       `json:"total_rows"`
	Data       []ServiceBodyshopResponse `json:"data"`
}

type ServiceBodyshopWoResponse struct {
	WorkOrderSystemNumber   int    `json:"work_order_system_number"`
	WorkOrderDocumentNumber string `json:"work_order_document_number"`
	WorkOrderDate           string `json:"work_order_date"`
	ModelName               string `json:"model_name"`
