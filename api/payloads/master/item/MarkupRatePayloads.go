...
type MarkupRateListResponse struct {
	...
	MarkupMasterCode        string  `json:"markup_master_code" parent_entity:"mtr_markup_master"`
	MarkupMasterDescription string  `json:"markup_master_description" parent_entity:"mtr_markup_master"`
