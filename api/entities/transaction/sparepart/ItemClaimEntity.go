...
type ItemClaim struct {
	...
	//WarehouseGroup             *masterwarehouseentities.WarehouseGroup //`gorm:"foreignKey:WarehouseGroupIds;references:WarehouseGroupId"`
	...
	CurrencyRateType         int       `gorm:"column:currency_rate_type;null;size:25" json:"currency_rate_type"`
