...
type WorkOrder struct {
	...
	BilltoCustomerId              int       `gorm:"column:customer_id;size:30;" json:"customer_id"`
	...
	WorkOrderEraExpiredDate       time.Time `gorm:"column:work_order_era_expired_date;type:datetime" json:"work_order_era_expired_date"`
	QueueSystemNumber             int       `gorm:"column:queue_system_number;size:30;" json:"queue_system_number"`
	WorkOrderArrivalTime          time.Time `gorm:"column:work_order_arrival_time;type:datetime" json:"work_order_arrival_time"`
	WorkOrderCurrentMileage       int       `gorm:"column:work_order_current_mileage;size:30;" json:"work_order_current_mileage"`
	...
	Titleprefix                   string    `gorm:"column:title_prefix;type:varchar(200)" json:"title_prefix"`
	NameCust                      string    `gorm:"column:name_customer;type:varchar(200)" json:"name_customer"`
	PhoneCust                     string    `gorm:"column:phone_customer;type:varchar(200)" json:"phone_customer"`
	MobileCust                    string    `gorm:"column:mobile_customer;type:varchar(200)" json:"mobile_customer"`
	MobileCustAlternative         string    `gorm:"column:mobile_customer_alternative;type:varchar(200)" json:"mobile_customer_alternative"`
	MobileCustDriver              string    `gorm:"column:mobile_customer_driver;type:varchar(200)" json:"mobile_customer_driver"`
	ContactVia                    string    `gorm:"column:contact_via;type:varchar(200)" json:"contact_via"`
	WorkOrderStatusInsurance      bool      `gorm:"column:work_order_status_insurance" json:"work_order_status_insurance"`
	WorkOrderInsurancePolicyNo    string    `gorm:"column:insurance_policy_no;type:varchar(200)" json:"insurance_policy_no"`
	WorkOrderInsuranceExpiredDate time.Time `gorm:"column:insurance_expired_date;type:datetime" json:"insurance_expired_date"`
	WorkOrderInsuranceClaimNo     string    `gorm:"column:insurance_claim_no;type:varchar(200)" json:"insurance_claim_no"`
	WorkOrderInsurancePic         string    `gorm:"column:insurance_pic;type:varchar(200)" json:"insurance_pic"`
	WorkOrderInsuranceWONumber    string    `gorm:"column:insurance_workorder_number;type:varchar(200)" json:"insurance_workorder_number"`
