...
type BookingEstimationServiceReminder struct {
	BookingEstimationReminderID int    `gorm:"column:booking_estimation_reminder_id;size:30;primaryKey" json:"booking_estimation_reminder_id"`
	...
	BookingServiceReminder      string `gorm:"column:booking_service_reminder;not null;size:50;" json:"booking_service_reminder"`
}
