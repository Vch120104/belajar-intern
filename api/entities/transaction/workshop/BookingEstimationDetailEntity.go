...
const TableNameBookingEstimationDetail = "trx_booking_estimation_item_detail"
...
type BookingEstimationDetail struct {
	...
	ItemOperationID                int        `gorm:"column:item_operation_id;size:30;default:null" json:"item_id"`
	...
	ItemOperationPrice             float64    `gorm:"column:item_operation_price;default:null" json:"item_price"`
	DiscountItemOperationAmount    float64    `gorm:"column:discount_item_operation_amount;default:null" json:"discount_item_amount"`
	DiscountItemOperationPercent   float64    `gorm:"column:discount_item_operation_percent;default:null" json:"discount_item_percent"`
