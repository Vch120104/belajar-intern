...
type ContractService struct {
	...
	ContractServiceSystemNumber   int       `gorm:"column:contract_service_system_number;size:30;primaryKey" json:"contract_service_system_number"`
	ContractServiceDocumentNumber string    `gorm:"column:contract_Service_document_number;size:256" json:"contract_service_document_number"`
