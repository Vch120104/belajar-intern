...
type OperationFrt struct {
	...
	OperationModelMappingId int     `gorm:"column:operation_model_mapping_id;not null;size:30;uniqueIndex:idx_modelmapping_variant" json:"operation_model_mapping_id"`
	VariantId               int     `gorm:"column:variant_id;size:30;not null;uniqueIndex:idx_modelmapping_variant" json:"variant_id"`
