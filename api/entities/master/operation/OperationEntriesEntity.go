...
type OperationEntries struct {
	...
	OperationEntriesId   int            `gorm:"column:operation_entries_id;not null;primaryKey"  json:"operation_entries_id"`
	...
	OperationSectionId   int            `gorm:"column:operation_section_id;not null"  json:"operation_section_id"`
	OperationSection     OperationSection 
	OperationKeyId       int            `gorm:"column:operation_key_id;not null"  json:"operation_key_id"`
