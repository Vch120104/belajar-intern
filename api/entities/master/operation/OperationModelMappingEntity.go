...
type OperationModelMapping struct {
	...
	BrandId                 int           `gorm:"column:brand_id;not null" json:"brand_id"` //fk luar
	ModelId                 int           `gorm:"column:model_id;not null" json:"model_id"` //fk luar
	OperationId             int           `gorm:"column:operation_id;not null" json:"operation_id"`
