...
type OperationSection struct {
	...
	OperationGroup              *OperationGroup  `gorm:"foreignKey:OperationGroupId;references:OperationGroupId" json:"operation_group"`
	...
	OperationEntries            OperationEntries `gorm:"foreignKey:OperationSectionId;references:OperationSectionId" json:"operation_entries"`
	OperationKey                OperationKey     `gorm:"foreignKey:OperationSectionId;references:OperationSectionId" json:"operation_key"`
}
