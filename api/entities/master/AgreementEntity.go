...
type Agreement struct {
	...
	AgreementItemDetail          []AgreementItemDetail          `gorm:"foreignKey:AgreementId;" json:"agreement_item"`
	AgreementDiscountGroupDetail []AgreementDiscountGroupDetail `gorm:"foreignKey:AgreementId;" json:"agreement_discount_group"`
}
