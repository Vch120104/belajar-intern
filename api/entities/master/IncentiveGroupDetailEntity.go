...
type IncentiveGroupDetail struct {
	...
	IncentiveGroupId       int  `gorm:"column:incentive_group_id;not null; size:30;uniqueindex:idx_level_detail" json:"incentive_group_id"`
	IncentiveGroup         IncentiveGroup
	IncentiveLevel         float64 `gorm:"column:incentive_level;not null;uniqueindex:idx_level_detail" json:"incentive_level"`
