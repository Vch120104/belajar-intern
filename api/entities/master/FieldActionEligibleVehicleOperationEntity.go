...
type FieldActionEligibleVehicleOperation struct {
	...
	FieldActionEligibleVehicleOperationSystemNumber int                        `gorm:"column:field_action_eligible_vehicle_operation_system_number;size:30;not null;primaryKey"        json:"field_action_eligible_vehicle_operation_system_number"`
	...
	FieldActionEligibleVehicleOperationLineNumber   float64                    `gorm:"column:field_action_eligible_vehicle_operation_line_number;null"        json:"field_action_eligible_vehicle_operation_line_number"`
