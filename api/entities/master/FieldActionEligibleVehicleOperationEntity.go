...
type FieldActionEligibleVehicleOperation struct {
	...
	FieldActionEligibleVehicleOperationSystemNumber int                        `gorm:"column:field_action_eligible_vehicle_item_system_number;not null;primaryKey"        json:"field_action_eligible_vehicle_operation_system_number"`
