...
type AgreementDiscountGroupDetail struct {
	AgreementDiscountGroupDetailId int     `gorm:"column:agreement_discount_group_id;size:30;not null;primaryKey" json:"agreement_discount_group_id"`
	AgreementId                    int     `gorm:"column:agreement_id;size:30;not null;" json:"agreement_id"`
	AgreementSelection             string  `gorm:"column:agreement_selection;size:30;not null" json:"agreement_selection"`
	AgreementOrderType             string  `gorm:"column:agreement_order_type;size:30;not null" json:"agreement_order_type"`
