...
type AgreementDiscountGroupDetail struct {
	...
	AgreementSelection        int     `gorm:"column:agreement_selection_id;size:30;not null" json:"agreement_selection_id"`
	AgreementOrderTypeId      int     `gorm:"column:agreement_order_type_id;size:30;not null" json:"agreement_order_type_id"`
