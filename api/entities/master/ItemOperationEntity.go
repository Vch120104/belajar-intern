...
type ItemOperation struct {
	...
	PackageMasterDetail     *PackageMasterDetail  `gorm:"foreignKey:ItemOperationId;references:ItemOperationId"`
	CampaignMasterDetail    *CampaignMasterDetail `gorm:"foreignKey:ItemOperationId;references:ItemOperationId"`
}
