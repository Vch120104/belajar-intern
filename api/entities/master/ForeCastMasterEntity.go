...
type ForecastMaster struct {
	...
	ForecastMasterId           int  `gorm:"column:forecast_master_id;size:30;not null;primaryKey"        json:"forecast_master_id"`
	...
	MovingCodeId               int  `gorm:"column:moving_code_id;size:30;not null"      json:"moving_code_id"`
	MovingCode                 MovingCode
	OrderTypeId                int     `gorm:"column:order_type_id;size:30;not null" json:"order_type_id"`
