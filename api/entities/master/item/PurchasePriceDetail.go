...
type PurchasePriceDetail struct {
	...
	PurchasePriceId       int     `gorm:"column:purchase_price_id;size:30;not null;uniqueIndex:idx_purchase_price_detail" json:"purchase_price_id"`
	ItemId                int     `gorm:"column:item_id;size:30;not null;uniqueIndex:idx_purchase_price_detail" json:"item_id"`
