...
type ItemLevel2 struct {
	...
	ItemLevel1Id   int  `gorm:"column:item_level_1_id;size:30;not null;uniqueindex:idx_item_level_2" json:"item_level_1_id"`
	...
	ItemLevel2Name string `gorm:"column:item_level_2_name;not null;size:100" json:"item_level_2_name"`
}
