...
type ItemLevel3 struct {
	...
	ItemLevel2Id   int  `gorm:"column:item_level_2_id;size:30;not null;uniqueindex:idx_item_level_3" json:"item_level_2_id"`
	...
	ItemLevel3Name string `gorm:"column:item_level_3_name;not null;size:100" json:"item_level_3_name"`
}
