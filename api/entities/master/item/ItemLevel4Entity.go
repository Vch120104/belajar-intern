...
type ItemLevel4 struct {
	...
	ItemLevel3Id   int  `gorm:"column:item_level_3_id;size:30;not null;uniqueindex:idx_item_level_4" json:"item_level_3_id"`
	...
	ItemLevel4Name string `gorm:"column:item_level_4_name;not null;size:100" json:"item_level_4_name"`
}
