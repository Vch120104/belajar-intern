...
type ItemClass struct {
	...
	LineTypeID    int           `gorm:"column:line_type_id;size:30;null" json:"line_type_id"`        //FK with mtr_line_type common-general service
	...
	PriceList     ItemPriceList `gorm:"foreignKey:ItemClassId;references:ItemClassId"`
}
