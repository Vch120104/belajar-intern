...
type Item struct {
	...
	//impact recursive	//ItemPackageDetail            []ItemPackageDetail `gorm:"foreignKey:item_id;references:item_id"`
	//impact recursive	//ItemImport                   []ItemImport        `gorm:"foreignKey:item_id;references:item_id"`
}
