...
type Item struct {
	...
	ItemClassId                  int    `gorm:"column:item_class_id;size:30;not null"        json:"item_class_id"` //FK dalam mtr_item_class
	...
	SupplierId                   int    `gorm:"column:supplier_id;size:30;not null"        json:"supplier_id"`                                 //FK luar with mtr_supplier general service
	UnitOfMeasurementTypeId      int    `gorm:"column:unit_of_measurement_type_id;size:30;not null"        json:"unit_of_measurement_type_id"` //FK luar with mtr_unit_of_measurement_type
	UnitOfMeasurementSellingId   int    `gorm:"column:unit_of_measurement_selling_id;size:30;null"        json:"unit_of_measurement_selling_id"`
	UnitOfMeasurementSelling     Uom    `gorm:"foreignKey:UnitOfMeasurementSellingId"`
	UnitOfMeasurementPurchaseId  int    `gorm:"column:unit_of_measurement_purchase_id;size:30;null" json:"unit_of_measurement_purchase_id"`
	UnitOfMeasurementPurchase    Uom    `gorm:"foreignKey:UnitOfMeasurementPurchaseId"`
	UnitOfMeasurementStockId     int    `gorm:"column:unit_of_measurement_stock_id;size:30;null" json:"unit_of_measurement_stock_id"`
	...
	MarkupMasterId               int `gorm:"column:markup_master_id;size:30;not null"        json:"markup_master_id"` //FK dalam mtr_markup_master
	...
	DimensionUnitOfMeasurementId int     `gorm:"column:dimension_unit_of_measurement_id;size:30;null" json:"dimension_unit_of_measurement_id"`
	...
	StorageTypeId           int                  `gorm:"column:storage_type_id;size:30;not null"        json:"storage_type_id"` //FK luar with storage_type general service
	Remark                  string               `gorm:"column:remark;size:512;null"        json:"remark"`
	AtpmWarrantyClaimTypeId int                  `gorm:"column:atpm_warranty_claim_type_id;size:30;null"        json:"atpm_warranty_claim_type_id"` //FK luar with mtr_warranty_claim_type common service
	...
	SpecialMovementId       int                  `gorm:"column:special_movement_id;size:30;not null"        json:"special_movement_id"` //FK luar with mtr_special_movement common service
	...
	AtpmSupplierId          int                  `gorm:"column:atpm_supplier_id;size:30;not null"        json:"atpm_supplier_id"` //FK luar with mtr_supplier general service
	...
	GmmCatalogCode          int                  `gorm:"column:gmm_catalog_code;size:30;null"        json:"gmm_catalog_code"`
	...
	SourceTypeId            int                  `gorm:"column:source_type_id;size:30;null"        json:"source_type_id"`                           //fk luar with mtr_atpm_order_type common service
	AtpmSupplierCodeOrderId int                  `gorm:"column:atpm_supplier_code_order_id;size:30;null"        json:"atpm_supplier_code_order_id"` //FK luar with mtr_supplier general service
	PersonInChargeId        int                  `gorm:"column:person_in_charge_id;size:30;null"        json:"person_in_charge_id"`                 //FK luar with mtr_user_details general service
