...
type FieldActionEligibleVehicle struct {
	...
	FieldActionRecallLineNumber   string 	`gorm:"column:field_action_recall_line_number;not null"        json:"field_action_recall_line_number"`
	FieldActionSystemNumber       string 	`gorm:"column:field_action_system_number;not null"        json:"field_action_system_number"`
	FieldAction                   FieldAction
	BrandId                       string    `gorm:"column:brand_id;not null"        json:"brand_id"`
	...
	FieldActionDate               time.Time `gorm:"column:field_action_date;not null"        json:"field_action_date"`
