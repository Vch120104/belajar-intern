...
type FieldActionEligibleVehicle struct {
	...
	FieldActionEligibleVehicleSystemNumber int         `gorm:"column:field_action_eligible_vehicle_system_number;not null;primaryKey"        json:"field_action_eligible_vehicle_system_number"`
	FieldActionRecallLineNumber            int         `gorm:"column:field_action_recall_line_number;null"        json:"field_action_recall_line_number"`
