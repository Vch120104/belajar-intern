...
type AgreementItemDetail struct {
	...
	AgreementItemOperationCode        string  `gorm:"column:agreement_item_operation_code;size:30;null;" json:"agreement_item_operation_code"`
	AgreementItemOperationDescription string  `gorm:"column:agreement_item_operation_description;size:50;null;" json:"agreement_item_operation_description"`
