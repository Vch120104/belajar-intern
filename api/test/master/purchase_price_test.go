...
// func (m *MockPurchasePriceService) GetPurchasePriceDetailById(id int) (masteritempayloads.PurchasePriceDetailRequest, *exceptions.BaseErrorResponse) {
// 	args := m.Called(id)
// 	return args.Get(0).(masteritempayloads.PurchasePriceDetailRequest), args.Get(1).(*exceptions.BaseErrorResponse)
// }
...
// // func TestGetAllPurchasePriceById(t *testing.T) {
// // 	id := 1 // Change to the appropriate ID
// // 	req, _ := http.NewRequest("GET", "http://localhost:8000/v1/purchase-price/detail/"+strconv.Itoa(id), nil)
// // 	rr := httptest.NewRecorder()
...
// // 	}
// // 	mockService := new(MockPurchasePriceService)
// // 	mockService.On("GetAllPurchasePriceDetail", mock.Anything, mock.Anything).
// // 		Return(responseData, len(responseData), len(responseData), (*exceptions.BaseErrorResponse)(nil))

// // 	controller := masteritemcontroller.NewPurchasePriceController(mockService)
// // 	controller.GetAllPurchasePriceDetail(rr, req)
