...
type ItemWarehouseTransferRequestRepository interface {
	...
	SubmitWhTransferRequest(*gorm.DB, int) (transactionsparepartentities.ItemWarehouseTransferRequest, *exceptions.BaseErrorResponse)
	...
	DeleteDetail(*gorm.DB, int) (bool, *exceptions.BaseErrorResponse)
}
