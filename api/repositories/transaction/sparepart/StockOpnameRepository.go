...
type StockOpnameRepository interface {
	// GetAllStockOpname(*gorm.DB, []utils.FilterCondition, pagination.Pagination) (pagination.Pagination, *exceptions.BaseErrorResponse)
	...
	// GetListForOnGoing(*gorm.DB, string) *exceptions.BaseErrorResponse
