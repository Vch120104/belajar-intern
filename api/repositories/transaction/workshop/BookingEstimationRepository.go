...
type BookingEstimationRepository interface {
	...
	CopyFromHistory(tx *gorm.DB,id int)([]map[string]interface{},*exceptions.BaseErrorResponse)
	AddPackage(tx *gorm.DB, id int, packId int) ([]map[string]interface{}, *exceptions.BaseErrorResponse)
	AddContractService(tx *gorm.DB, id int, contractserviceid int) ([]map[string]interface{}, *exceptions.BaseErrorResponse)
	...
	PutBookingEstimationCalculation (tx *gorm.DB, id int, linetypeid int)([]map[string]interface{},*exceptions.BaseErrorResponse)
