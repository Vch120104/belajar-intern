...
type BookingEstimationRepository interface {
	...
	SaveDetailBookEstim(tx *gorm.DB, id int, req transactionworkshoppayloads.BookingEstimationDetailRequest) (transactionworkshopentities.BookingEstimationDetail, *exceptions.BaseErrorResponse)
