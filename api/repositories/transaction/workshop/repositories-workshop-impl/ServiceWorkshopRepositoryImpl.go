...
// --USE IN MODUL :
func (r *ServiceWorkshopRepositoryImpl) StartService(tx *gorm.DB, idAlloc int, idSysWo int, companyId int) (bool, *exceptions.BaseErrorResponse) {
...
// --USE FOR : * INSERT NEW DATA OR UPDATE IF SERVICE STATUS IS START, PENDING OR STOP
// --USE IN MODUL :
func (r *ServiceWorkshopRepositoryImpl) PendingService(tx *gorm.DB, idAlloc int, idSysWo int, companyId int) (bool, *exceptions.BaseErrorResponse) {
