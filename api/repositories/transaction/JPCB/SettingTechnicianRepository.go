...
type SettingTechnicianRepository interface {
	...
	GetSettingTechnicianByCompanyDate(tx *gorm.DB, companyId int, effectiveDate time.Time) (transactionjpcbpayloads.SettingTechnicianGetByIdResponse, *exceptions.BaseErrorResponse)
