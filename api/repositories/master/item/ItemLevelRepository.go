...
type ItemLevelRepository interface {
	...
	GetItemLevelDropDown(tx *gorm.DB, itemLevel int) ([]masteritemlevelpayloads.GetItemLevelDropdownResponse, *exceptions.BaseErrorResponse)
	...
	GetItemLevelLookUpbyId(tx *gorm.DB, filter []utils.FilterCondition, itemLevelId int) (masteritemlevelpayloads.GetItemLevelLookUp, *exceptions.BaseErrorResponse)
