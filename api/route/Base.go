...
func FieldActionRouter(
	...
	router.Post("/vehicle-item/{field_action_eligible_vehicle_system_number}", FieldActionController.PostFieldActionVehicleItemDetail)
	...
	router.Post("/item-into-vehicle-detail", FieldActionController.PostVehicleItemIntoAllVehicleDetail)
