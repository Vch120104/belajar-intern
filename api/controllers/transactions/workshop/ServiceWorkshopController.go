...
// @Tags Transaction : Workshop Service
...
// @Router /v1/service-workshop [get]
...
// @Success 200 {object}  payloads.Response
// @Failure 500,400,401,404,403,422 {object} exceptions.BaseErrorResponse
// @Router /v1/service-workshop/{technician_allocation_system_number}/{work_order_system_number}/{service_log_system_number}/{company_id}/start [post]
...
// @Success 200 {object}  payloads.Response
// @Failure 500,400,401,404,403,422 {object} exceptions.BaseErrorResponse
// @Router /v1/service-workshop/{technician_allocation_system_number}/{work_order_system_number}/{company_id}/pending [post]
...
// @Success 200 {object}  payloads.Response
// @Failure 500,400,401,404,403,422 {object} exceptions.BaseErrorResponse
// @Router /v1/service-workshop/{technician_allocation_system_number}/{work_order_system_number}/{company_id}/transfer [post]
...
// @Success 200 {object}  payloads.Response
// @Failure 500,400,401,404,403,422 {object} exceptions.BaseErrorResponse
// @Router /v1/service-workshop/{technician_allocation_system_number}/{work_order_system_number}/{company_id}/stop [post]
