...
type CampaignMasterService interface {
	...
	GetByIdCampaignMaster(int) (masterpayloads.CampaignMasterResponse, *exceptions.BaseErrorResponse)
	GetByIdCampaignMasterDetail(id int) (map[string]interface{}, *exceptions.BaseErrorResponse)
	GetByCodeCampaignMaster(code string) (masterpayloads.CampaignMasterResponse, *exceptions.BaseErrorResponse)
