...
// func (s *PurchasePriceServiceImpl) PopupPurchasePrice(filterCondition []utils.FilterCondition, pages pagination.Pagination) ([]map[string]interface{}, int, int, *exceptionsss_test.BaseErrorResponse) {
// 	tx := s.DB.Begin()
// 	defer helper.CommitOrRollback(tx)
// 	results, totalPages, totalRows, err := s.PurchasePriceRepo.PopupPurchasePrice(tx, filterCondition, pages)
// 	if err != nil {
// 		return results, totalPages, totalRows, err
// 	}
// 	return results, totalPages, totalRows, nil
