...
type FieldActionService interface {
	...
	GetAllFieldActionVehicleItemOperationDetailById(int, pagination.Pagination) (pagination.Pagination, *exceptions.BaseErrorResponse)
	GetFieldActionVehicleItemDetailById(Id int) (masterpayloads.FieldActionEligibleVehicleItemOperationResp, *exceptions.BaseErrorResponse)
	PostFieldActionVehicleItemDetail(Id int, req masterpayloads.FieldActionEligibleVehicleItemOperationRequest) (bool, *exceptions.BaseErrorResponse)
	...
	PostVehicleItemIntoAllVehicleDetail(headerId int, req masterpayloads.FieldActionEligibleVehicleItemOperationRequest) (bool, *exceptions.BaseErrorResponse)
