...
type FieldActionService interface {
	...
	GetAllFieldActionVehicleItemDetailById(int, pagination.Pagination) ([]map[string]interface{}, int, int, *exceptions.BaseErrorResponse)
	GetFieldActionVehicleItemDetailById(int, int) (map[string]interface{}, *exceptions.BaseErrorResponse)
